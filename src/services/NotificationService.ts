...
export class NotificationService {
  ...
  async initialize(
    ...
    try {
      ...
      ClixLogger.info('Initializing setupMessageHandlers');
  ...
  private setupMessageHandlers(): void {
    console.log('\n\n\nInitializing onMessage\n\n\n');
    this.unsubscribeForegroundMessage = messaging().onMessage(
      async (remoteMessage) => {
        console.log(JSON.stringify(remoteMessage));
        await this.onForegroundMessage(remoteMessage);
      }
    );
    this.unsubscribeNotificationOpened = messaging().onNotificationOpenedApp(
      async (remoteMessage) => {
